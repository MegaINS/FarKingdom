...
import ru.megains.farlands.Logger
import ru.megains.farlands.network.handler.INetHandler
import ru.megains.farlands.network.packet.Packet
import ru.megains.farlands.network.protocol.WoDChannelInitializer


object NetworkManager extends SimpleChannelInboundHandler[Packet[INetHandler]] with Logger[NetworkManager]{
